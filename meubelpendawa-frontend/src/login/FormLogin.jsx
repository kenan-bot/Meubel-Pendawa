...
export default function FormLogin({ onClose }) {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#5B21F5] px-4 py-8 relative">
      ...
      {/* TOMBOL TUTUP (×) — muncul hanya jika onClose diberikan */}
      {onClose && (
        <button
          onClick={onClose}
      ...
      <div className="w-full max-w-4xl flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">
        ...
        <div className="bg-white rounded-2xl shadow-xl flex flex-col items-center justify-center px-10 py-12 w-full max-w-xs md:max-w-sm flex-shrink-0">
          {/* Icon Box */}
          <div className="bg-[#5B21F5] rounded-2xl w-44 h-44 flex items-center justify-center mb-6">
            {/* Sofa / Chair SVG */}
            <svg
            ...
            >
              ...
              {/* Right armrest */}
              <rect x="64" y="22" width="12" height="24" rx="5" fill="white" />
              {/* Left leg */}
          ...
          {/* Title */}
          <h1 className="text-[#5B21F5] text-xl md:text-2xl font-bold text-center leading-tight">
            Internal Management
            <br />
            System
          </h1>
        ...
        <div className="w-full max-w-sm md:max-w-md flex flex-col">
          ...
          <p className="text-white/70 text-sm mb-7">Login Portal Management</p>
          ...
          <div className="flex flex-col gap-5">
            ...
            <button
              onClick={handleLogin}
              disabled={loading}
              className="w-full bg-amber-400 hover:bg-amber-500 active:scale-[0.98] text-white font-semibold text-base rounded-xl py-3.5 mt-2 transition-all duration-150 disabled:opacity-70 disabled:cursor-not-allowed"
            >
              {loading ? (
