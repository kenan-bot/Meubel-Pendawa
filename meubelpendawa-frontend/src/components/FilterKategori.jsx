...
const FilterKategori = ({ mode = "owner", onSelect }) => {
    ...
    <AnimatedSection delay={0.1}>
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="relative transition-all duration-200 hover:scale-[1.02]">
          ...
          <div className={`w-32 py-1 px-2 pr-6 rounded-md cursor-pointer
          ...
          {/* drop down */}
          <div className={`absolute top-[105%] w-32 z-50 rounded-md shadow-lg
          ...
          >
            <div className="flex flex-col">
              <div
                className={`pl-3 p-1.5 py-1 px-1 rounded-t ${isHome ? "text-[#5F04E8] bg-purple-100 hover:bg-[#F3EDFF]"
                : "text-orange-500 bg-orange-50"} hover:font-bold hover:scale-[1.02] active:scale-95
              ...
              {kategori.map((item, index) => (
                <div key={item.idKategori}>
                  <div
                    className={`pl-3 p-1.5 py-1 px-1 ${isHome ? "text-[#5F04E8] bg-purple-100 hover:bg-[#F3EDFF]" 
                    : "text-orange-500 bg-orange-50"} hover:font-bold hover:scale-[1.02] active:scale-95
                    transition-all duration-200 cursor-pointer
