...
public final class WilayahAlias {

    private WilayahAlias() {
    }
    ...
    public static final Map<String, String> DATA = Map.ofEntries(
            ...
            Map.entry("panjang", "Ambarawa"),
            Map.entry("bejalen", "Ambarawa"),
            ...
            Map.entry("poncoruso", "Bawen"),
            Map.entry("polosiri", "Bawen"),
            ...
            Map.entry("langensari", "Ungaran Barat"),
            Map.entry("candirejo", "Ungaran Barat"),
            ...
            Map.entry("leyangan", "Ungaran Timur"),
            ...
            Map.entry("candi", "Bandungan"),

            // getasan
            Map.entry("getasan", "Getasan"),
            Map.entry("kopeng", "Getasan"),
